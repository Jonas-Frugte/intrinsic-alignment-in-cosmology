...
Thusfar we have only considered an expansion local in the second derivatives of the graviational potential. Higher order derivatives can and should also be considered.
TODO: this part is not really clear to me, where does the $R^2$ come from in equation 2.17 of "Effective Field Theory of Instrinsic Alignments ..."? Why is it third order in the matter density perturbations?
%TODO: why? perhaps consider this further, we are basically saying here that the gravitational potential should vary significantly on a scale R_* much larger than the scale of our tracers, does this conflict with anything else?
